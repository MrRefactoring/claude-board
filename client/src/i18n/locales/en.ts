export default {
  ...
  'projectModal.autoMergeDesc': "Merge the task branch into the base on success (skips a dirty tree; keeps the branch on conflict). Off: the branch is kept for you to merge manually — it's never deleted.",
  ...
  'detail.branchKept': 'kept for manual merge',
  'detail.workLocation': 'Work location',
  'detail.copy': 'Copy',
  'detail.statusPrMerged': 'PR merged',
  'detail.statusPrOpen': 'PR open',
  'detail.statusPushed': 'Pushed',
  'detail.statusLocalOnly': 'Local — not pushed',
  'detail.worktreeRemoved': 'Worktree removed — work safe on remote',
  'detail.worktreeUnknown': 'Worktree location not recorded',
  'detail.pushBranch': 'Push branch',
  ...
  'settings.chatBypassPermissions': 'Chat Full Autonomy',
  'settings.chatBypassPermissionsDesc': 'Let the AI chat use all tools without asking. When off, each new tool prompts Yes / Always / Deny.',
