export default {
  ...
  // ─── Board ───
  'board.board': 'Pano',
  'board.autoQueue': 'Otomatik Kuyruk',
  'board.list': 'Liste',
  'board.summary': '\u00d6zet',
  ...
  'detail.workLocation': 'Çalışma konumu',
  'detail.copy': 'Kopyala',
  'detail.statusPrMerged': 'PR birleştirildi',
  'detail.statusPrOpen': 'PR açık',
  'detail.statusPushed': 'Gönderildi',
  'detail.statusLocalOnly': 'Yerel — gönderilmedi',
  'detail.worktreeRemoved': 'Worktree kaldırıldı — iş remote’da güvende',
  'detail.worktreeUnknown': 'Worktree konumu kaydedilmedi',
  'detail.pushBranch': 'Dalı gönder',
  'detail.createPr': 'PR oluştur',
