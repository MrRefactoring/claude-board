...
function GeneralTab({ settings, onChange, t, models }: GeneralTabProps) {
  return (
...
function NotificationsTab({ settings, onChange, t }: NotificationsTabProps) {
...
function ModelsTab({ t, models }: ModelsTabProps) {
