...
function SnippetForm({ snippet, onSave, onCancel, t }: SnippetFormProps) {
...
export default function SnippetsModal({ projectId, projectName, onClose }: Props) {
