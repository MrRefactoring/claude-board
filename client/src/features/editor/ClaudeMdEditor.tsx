...
export default function ClaudeMdEditor({ projectId, projectName, onClose }: ClaudeMdEditorProps) {
  ...
  const loadFile = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = (await api.getClaudeMd(projectId)) as ClaudeMdResponse;
      if (data.exists) {
