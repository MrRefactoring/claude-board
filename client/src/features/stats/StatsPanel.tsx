...
interface ProjectStats {
  byStatus?: StatCount[];
  byType?: StatCount[];
  byPriority?: { label: number | string; count: number }[];
  claudeUsage?: StatsClaudeUsage;
...
function BarChart({ data, colorMap, labelMap, maxVal }: BarChartProps) {
...
export default function StatsPanel({ projectId, onClose }: { projectId: number; onClose: () => void }) {
  ...
  const usage: StatsClaudeUsage = stats?.claudeUsage || {};
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        {loading && !stats ? (
          ...
          <>
            ...
            {/* Model Breakdown */}
            {(stats?.modelBreakdown?.length ?? 0) > 0 && (
              <div>
                      ...
                      <div key={i} className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div
                            ...
                            style={{
                              backgroundColor: MODEL_COLORS[displayName as keyof typeof MODEL_COLORS] || '#6b7280',
                            }}
                          />
            ...
            {(stats?.recentCompleted?.length ?? 0) > 0 && (
              <div>
                ...
                <div className="p-3 rounded-lg bg-surface-800 border border-surface-700/50">
                  <div className="grid grid-cols-3 gap-3 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-xs font-medium text-claude">
