...
interface Props {
  ...
  setDeps: Dispatch<SetStateAction<TaskDependencies>>;
  allTasks: Task[];
  currentStatus: TaskStatus;
  addDepId: string;
  setAddDepId: Dispatch<SetStateAction<string>>;
  addDepDirection: string;
  setAddDepDirection: Dispatch<SetStateAction<string>>;
}
