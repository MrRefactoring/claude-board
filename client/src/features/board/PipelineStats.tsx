...
export default function PipelineStats({ tasks, waves, projectId }: PipelineStatsProps) {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((d) => setPipelineData(d as PipelineData))
      .catch(() => {});
  ...
  const awaitingApproval = tasks.filter((t) => (t.status as string) === 'awaiting_approval');
