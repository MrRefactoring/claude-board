...
type ConflictInfo = { time?: number; [k: string]: unknown };
...
export default function ObservabilityPanel({ projectId }: ObservabilityPanelProps) {
  const { t } = useTranslation();
  const [data, setData] = useState<AgentActivityData>({ agents: [], fileMap: {}, conflicts: [] });
