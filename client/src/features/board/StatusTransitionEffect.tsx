...
interface ConfettiPiece extends Particle {
  shape: 'rect' | 'circle';
  wobble: number;
}

// ─── Particle generation ───
function generateParticles(count: number, color: string, spread = 80): Particle[] {
...
interface StatusTransitionEffectProps {
  from: string;
  to: string;
}

export default function StatusTransitionEffect({ from, to }: StatusTransitionEffectProps) {
