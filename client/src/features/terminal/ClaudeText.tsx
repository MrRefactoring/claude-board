...
export function ThinkingBlock({ message, time }: { message?: string; time?: string }) {
...
export function ClaudeText({ message, time, isThinking }: { message?: string; time?: string; isThinking?: boolean }) {
